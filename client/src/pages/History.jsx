...
const History = () => {
  ...
  if (historyVideos.length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-[#0F0F0F] text-gray-700 dark:text-white">
        <h2 className="text-xl">No watch history found.</h2>
      </div>
    );
  }
